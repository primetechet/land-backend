...
import { TitleDeedApplicationAppointmentModule } from './models/title-deed-application-appointment/title-deed-application-appointment.module';
...
@Module({
  imports: [
    ...
    EmployeeModule,
    EmployeeRoleModule,
    TitleDeedApplicationAppointmentModule,
  ],
