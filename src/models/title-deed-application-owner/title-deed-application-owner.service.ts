  ...
  findAll(options: SearchTitleDeedApplicationOwnerDto) {
    ...
    return this.prisma.titleDeedApplicationOwner.findMany({
      ...
      select: {
        ...
        first_name_am: true,
        father_name_am: true,
        grand_father_name_am: true,
        mother_first_name: true,
        mother_father_name: true,
        mother_grand_father_name: true,
        mother_first_name_am: true,
        mother_father_name_am: true,
        mother_grand_father_name_am: true,
        gender: true,
        house_number: true,
